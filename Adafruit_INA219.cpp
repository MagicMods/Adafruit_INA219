 ...
 */
void Adafruit_INA219::setCalibration_32V_6A_02() {
  ...
  // 0.04) RSHUNT = 0.1               (Resistor value in ohms)
    // 0.04) RSHUNT = 0.02               (Resistor value in ohms)
  ...
  // MaximumLSB = 0,000488              (488uA per bit)
    ...
    // MinimumLSB = MaxExpected_I/32767
  // MinimumLSB = 0.0001830              (61uA per bit)
  // MaximumLSB = MaxExpected_I/4096
  // MaximumLSB = 0.001464             (488uA per bit)
  ...
  // ina219_powerMultiplier_mW = 2; // Power LSB = 1mW per bit (2/1)
    ...
    // Set multipliers to convert raw current/power values
  ina219_currentDivider_mA = 5; // Current LSB = 100uA per bit (1000/200 = 10)
  ina219_powerMultiplier_mW = 4; // Power LSB = 1mW per bit (4/1)
